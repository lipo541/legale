...
import type { CompanySpecialistProfile, City, VerificationStatus, LoadingStates } from '../types'

// ============================================================================
// Specialist Details - Memoized Component (for Company Specialists)
// ============================================================================
...
interface SpecialistDetailsProps {
  ...
  onEdit: (specialist: CompanySpecialistProfile) => void
  onChangeVerificationStatus: (specialist: CompanySpecialistProfile, status: VerificationStatus, notes?: string) => void
