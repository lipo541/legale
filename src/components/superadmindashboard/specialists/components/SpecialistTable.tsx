...
// ============================================================================
// Specialist Table - Memoized Component (for Company Specialists)
// ============================================================================
...
interface SpecialistTableProps {
  ...
  renderExpandedContent?: (specialist: CompanySpecialistProfile) => React.ReactNode
  renderTranslationsContent?: (specialist: CompanySpecialistProfile) => React.ReactNode
}
          ...
          <thead className={`${isDark ? 'bg-white/5' : 'bg-black/5'}`}>
            <tr>
              ...
              <th className={`px-2 py-2 text-left text-[10px] font-medium uppercase tracking-wider ${
                ...
                >
                  კომპანია
                  <SortIcon column="company_name" currentSort={sortBy} sortOrder={sortOrder} />
                </div>
              </th>
          ...
          <tbody className={`divide-y ${isDark ? 'divide-white/10' : 'divide-black/10'}`}>
            {specialists.map((specialist) => (
              <SpecialistRow
                ...
                onToggleChangeCompanyDropdown={onToggleChangeCompanyDropdown}
