...
import type { FiltersState, VerificationFilter, BlockFilter, Company } from '../types'

// ============================================================================
// Specialist Filters - Memoized Component (for Company Specialists)
// ============================================================================
...
const SpecialistFilters = memo(function SpecialistFilters({
  ...
  const companyOptions = useMemo(() => [
    { value: '', label: 'ყველა კომპანია' },
    ...companies.map(c => ({ value: c.id, label: c.full_name }))
  ], [companies])
        ...
        <div className={`mb-4 rounded-xl border p-2 sm:p-3 ${
          ...
          <div className="grid grid-cols-1 gap-2 sm:grid-cols-2 lg:grid-cols-7">
            ...
            <CustomSelect
              ...
              onChange={(value) => onUpdateFilter('companyFilter', value)}
