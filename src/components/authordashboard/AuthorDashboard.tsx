      ...
      case 'dashboard':
        return (
          <div>
            ...
            <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className={`rounded-xl border p-6 ${isDark ? 'border-white/10 bg-white/5' : 'border-black/10 bg-black/5'}`}>
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className={`text-sm ${isDark ? 'text-white/60' : 'text-black/60'}`}>Author Status</p>
                  </div>
                </div>
              </div>
              ...
              <div className={`rounded-xl border p-6 ${isDark ? 'border-white/10 bg-white/5' : 'border-black/10 bg-black/5'}`}>
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className={`text-2xl font-bold ${isDark ? 'text-white' : 'text-black'}`}>0</p>
                    <p className={`text-sm ${isDark ? 'text-white/60' : 'text-black/60'}`}>Total Views</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className={`flex items-center gap-4 p-6 rounded-xl border ${isDark ? 'border-white/10 bg-white/5' : 'border-black/10 bg-black/5'}`}>
                  ...
                  <div className="text-left">
                    <h3 className={`font-semibold ${isDark ? 'text-white' : 'text-black'}`}>Author Role</h3>
                    <p className={`text-sm ${isDark ? 'text-white/60' : 'text-black/60'}`}>You can publish articles</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Info Section */}
            <div className="mt-8">
              <div className={`rounded-xl border p-6 ${isDark ? 'border-white/10 bg-blue-500/5' : 'border-blue-500/20 bg-blue-500/5'}`}>
