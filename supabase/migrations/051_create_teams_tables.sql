...
-- Description: Creates tables for team management functionality
-- Author: System
-- Date: 2025-11-11

-- ============================================================================
-- 1. Create teams table (main team information)
-- ============================================================================
...
-- ============================================================================
-- 2. Create team_translations table (multilingual team content)
-- ============================================================================
...
-- Add indexes
CREATE INDEX IF NOT EXISTS idx_team_translations_team_id ON team_translations(team_id);
CREATE INDEX IF NOT EXISTS idx_team_translations_language ON team_translations(language);
CREATE INDEX IF NOT EXISTS idx_team_translations_slug ON team_translations(slug);

-- Add comment
COMMENT ON TABLE team_translations IS 'Stores multilingual content for teams (ka, en, ru) including slugs';

-- ============================================================================
-- 3. Create team_sections table (sections within a team)
-- ============================================================================
...
-- Add indexes
CREATE INDEX IF NOT EXISTS idx_team_sections_team_id ON team_sections(team_id);
CREATE INDEX IF NOT EXISTS idx_team_sections_order ON team_sections("order");

-- Add comment
COMMENT ON TABLE team_sections IS 'Stores sections within a team (e.g., Executive Board, Ethics Committee)';

-- ============================================================================
-- 4. Create team_section_translations table (multilingual section titles)
-- ============================================================================
...
-- Add indexes
CREATE INDEX IF NOT EXISTS idx_team_section_translations_section_id ON team_section_translations(section_id);
CREATE INDEX IF NOT EXISTS idx_team_section_translations_language ON team_section_translations(language);

-- Add comment
COMMENT ON TABLE team_section_translations IS 'Stores multilingual titles for team sections';

-- ============================================================================
-- 5. Create team_members table (associates specialists with team sections)
-- ============================================================================
...
DROP TRIGGER IF EXISTS update_team_translations_updated_at ON team_translations;
CREATE TRIGGER update_team_translations_updated_at
    BEFORE UPDATE ON team_translations
    FOR EACH ROW
    EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_team_sections_updated_at ON team_sections;
CREATE TRIGGER update_team_sections_updated_at
    BEFORE UPDATE ON team_sections
    FOR EACH ROW
    EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_team_section_translations_updated_at ON team_section_translations;
...
DROP POLICY IF EXISTS "Public can view team translations" ON team_translations;
...
DROP POLICY IF EXISTS "Super admins can manage team translations" ON team_translations;
...
DROP POLICY IF EXISTS "Super admins can manage team sections" ON team_sections;
...
DROP POLICY IF EXISTS "Public can view team section translations" ON team_section_translations;
...
DROP POLICY IF EXISTS "Super admins can manage team section translations" ON team_section_translations;
